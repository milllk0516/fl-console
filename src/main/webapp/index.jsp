...
<div class="container bs-docs-container">
	<div class="row" style="padding:10px;">
		<p>
          1. 点击添加视频，选择要上传的视频。<br/>
          2. 点击添加封面，选择要上传的封面。<br/>
          3. 点击开始上传，进行视频和封面的上传任务。<br/>
		</p>
	</div>
	...
	<div class="row" style="padding:10px;">
		...
		<a id="preview" href="javascript:void(0);" class="btn btn-outline">预览视频</a>
	</div>
...
<script type="text/javascript">
	...
	**/
	...
	$('#preview').on('click', function () {
		window.location.href="/playVideo.jsp";
	});
